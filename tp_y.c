...
static const char *const yytname[] =
{
  ...
  "CLASSDEF", "Cste", "RelOp", "'{'", "'}'", "'('", "')'", "';'", "':'",
  "','", "$accept", "Prog", "classLOpt", "classDecl", "classHeader",
  "extOpt", "block", "instList", "instListOpt", "inst", "declList",
  "declListOpt", "decl", "methListOpt", "meth", "overOpt", "isNotBlock",
  "isBlock", "typeOpt", "methHeader", "initInstOpt", "initBlockOpt",
  "affInst", "expression", "message", "instanc", "paramListOpt",
  "paramList", "cast", "select", "opexpr", "bexpr", "construct",
  "argListOpt", "argList", "arg", YY_NULLPTR
};
#endif
...
{
       8,    -7,    19,   -11,     8,    24,     1,    21,   -73,     6,
     -73,   -73,     9,    22,    17,   -11,    28,    -1,    -1,    -1,
      29,   -73,   -73,    10,   -73,   135,   -73,   -73,    25,   124,
      51,    52,   -73,    54,   -73,   -73,   -73,   -73,   -73,   -73,
      52,    23,    27,   -73,    38,    45,   -73,   -73,    46,    18,
      18,   159,    48,   -73,    59,    98,   -73,   -73,   124,   -73,
      52,    -1,    -1,    -1,    -1,    -1,    62,    -1,    -1,   -73,
       4,    61,   -73,    22,    -1,    73,   124,    -1,    64,   -73,
      69,   -73,    82,    56,    56,    18,    18,    70,    84,   173,
     -73,    74,     4,   111,   -73,   -73,    60,    88,   -73,    99,
     106,    91,    -1,   -73,   -73,    -1,   -73,   -73,   105,    95,
      -1,   -73,    -1,    92,   124,   -73,   103,   102,   108,   112,
     -73,   -73,   134,   -73,   187,   -73,   -73,   -73,   -73,    22,
     136,   -11,   113,    -1,   -73,   -73,   187
};
...
{
     -73,   -73,   146,   -73,   -73,   -73,    -3,    96,   127,   -72,
     -73,   -35,   131,    67,   -73,   -73,   -73,   -73,   -73,   -73,
     -73,   -73,   -73,   -16,   -73,   -73,   -71,    50,   -73,   -73,
     -73,   -73,   -73,    32,    90,   -73
};
...
{
      10,    49,    50,    51,   100,    70,   101,    17,    18,    55,
      16,   -27,    46,     1,    17,    18,    20,     6,     9,     8,
      19,    21,    22,    20,    90,    81,    24,    12,    21,    22,
      25,    23,    13,    24,   117,     9,    66,    25,    40,    67,
      14,    45,   126,    53,    41,    82,    83,    84,    85,    86,
      48,    88,    89,    52,    58,    56,    16,    71,    96,    72,
      61,    96,    62,    63,    64,    65,    64,    65,    62,    63,
      64,    65,    66,    73,    66,    67,    74,    67,    66,    77,
      75,    67,    68,    78,    87,    94,   116,    69,    68,    96,
      62,    63,    64,    65,    96,   110,   124,    99,   102,   103,
      66,   105,    66,    67,   106,   112,    62,    63,    64,    65,
      68,    62,    63,    64,    65,   104,    66,   136,   108,    67,
     111,    66,   114,   115,    67,   125,    68,   118,   134,   119,
      79,    68,    17,    18,   128,   127,   130,   131,    19,   129,
      31,    20,   133,    17,    18,   135,    21,    22,    54,    23,
      11,    24,    20,     9,    80,    25,    57,    21,    22,   107,
     123,   132,    24,    95,     0,     0,    25,    62,    63,    64,
      65,     0,     0,     0,    76,     0,     0,    66,     0,     0,
      67,    62,    63,    64,    65,     0,     0,    68,     0,     0,
       0,    66,     0,     0,    67,    62,    63,    64,    65,     0,
       0,   -28,     0,     0,     0,    66,     0,     0,    67,     0,
       0,     0,     0,     0,     0,    68
};

static const yytype_int16 yycheck[] =
{
       3,    17,    18,    19,    76,    40,    77,     8,     9,    25,
       4,     7,    15,     5,     8,     9,    17,    24,    29,     0,
      14,    22,    23,    17,    20,    60,    27,     3,    22,    23,
      31,    25,    31,    27,   105,    29,    18,    31,    29,    21,
      19,    24,   114,    33,    22,    61,    62,    63,    64,    65,
      22,    67,    68,    24,     3,    30,     4,    34,    74,    32,
       6,    77,     8,     9,    10,    11,    10,    11,     8,     9,
      10,    11,    18,    35,    18,    21,    31,    21,    18,    31,
      34,    21,    28,    24,    22,    24,   102,    33,    28,   105,
       8,     9,    10,    11,   110,    35,   112,    24,    34,    30,
      18,    31,    18,    21,    30,     6,     8,     9,    10,    11,
      28,     8,     9,    10,    11,    33,    18,   133,     7,    21,
      32,    18,    16,    32,    21,    33,    28,    22,   131,    34,
      32,    28,     8,     9,    32,    32,    24,     3,    14,    31,
       9,    17,     6,     8,     9,    32,    22,    23,    13,    25,
       4,    27,    17,    29,    58,    31,    29,    22,    23,    92,
     110,   129,    27,    73,    -1,    -1,    31,     8,     9,    10,
      11,    -1,    -1,    -1,    15,    -1,    -1,    18,    -1,    -1,
      21,     8,     9,    10,    11,    -1,    -1,    28,    -1,    -1,
      -1,    18,    -1,    -1,    21,     8,     9,    10,    11,    -1,
      -1,    28,    -1,    -1,    -1,    18,    -1,    -1,    21,    -1,
      -1,    -1,    -1,    -1,    -1,    28
};
...
{
       0,     5,    37,    38,    39,    40,    24,    68,     0,    29,
      42,    38,     3,    31,    19,    41,     4,     8,     9,    14,
      17,    22,    23,    25,    27,    31,    42,    43,    44,    45,
      46,    48,    58,    59,    60,    61,    64,    65,    66,    67,
      29,    22,    69,    70,    71,    24,    42,    57,    22,    59,
      59,    59,    24,    33,    13,    59,    30,    44,     3,    47,
      48,     6,     8,     9,    10,    11,    18,    21,    28,    33,
      47,    34,    32,    35,    31,    34,    15,    31,    24,    32,
      43,    47,    59,    59,    59,    59,    59,    22,    59,    59,
      20,    49,    50,    51,    24,    70,    59,    62,    63,    24,
      45,    62,    34,    30,    33,    31,    30,    49,     7,    55,
      35,    32,     6,    56,    16,    32,    59,    62,    22,    34,
      52,    53,    54,    63,    59,    33,    45,    32,    32,    31,
      24,     3,    69,     6,    42,    32,    59
};
...
#line 134 "tp.y" /* yacc.c:1646  */
    { (yyval.pT) = makeTree(NEWW, 2, (yyvsp[-3].S), (yyvsp[-1].pT)) ;}
